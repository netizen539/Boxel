...
#ifdef SPECULARMAP2D m_SpecularMap;
#endif
 // uniform sampler
...
void main(){
    ...
    #ifdef DIFFUSEARRAY
        vec3 bigTexCoord = vec3(newTexCoord[0], newTexCoord[1], textureID);
        vec4 diffuseColor = texture2DArray(m_DiffuseArray, bigTexCoord);
    #else
        #ifdef DIFFUSEMAP
